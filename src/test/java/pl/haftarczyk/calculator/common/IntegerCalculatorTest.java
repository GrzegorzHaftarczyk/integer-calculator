...
public abstract class IntegerCalculatorTest<T extends IntegerCalculator> {

    protected T integerCalculator;

    protected abstract T createIntegerCalculator();

    @BeforeEach
    void setUp() {
        integerCalculator = createIntegerCalculator();
    }
    ...
    void testCalculate(String expression, int expectedResult, String message) {
        int result = integerCalculator.calculate(expression);
    ...
    void testShouldThrowExceptionWhenDivideByZero() {
        Exception exception = assertThrows(ArithmeticException.class, () ->
                integerCalculator.calculate("3 / 0"));
    ...
    void testShouldThrowExceptionWhenExpressionIsInvalid(String expression, String message) {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                integerCalculator.calculate(expression), message);
